      ...
      <div class="container d-flex header-box">
        ...
        <nav class="nav-menu d-none d-lg-block">
            <ul class="d-flex m-0">
				...
				<li class="active"><a href="nextfollowups.php?dealer=<?php echo $district; ?>">Next Follow Up Enquires</a></li>
            ...
            <div class="container">
				...
				<div class="pb-3">
					<?php
						...
						<?php
						 $cdatesql = "select distinct convert(DATE,enquiry_date, 120 ) as enq_date from suzuki_campaign_data where vertical = '$district' and to_be_contacted_date >= '$mxdate'";
						...
						$cnamaefilsql = "SELECT  distinct (campaign_name) FROM suzuki_campaign_data where vertical = '$district' and to_be_contacted_date >= '$mxdate'";
						...
						echo "</select></div>";
						$citfilsql = "SELECT  distinct (city) FROM suzuki_campaign_data where vertical = '$district' and to_be_contacted_date >= '$mxdate'";
						...
						echo "</select></div>";
						$disfilsql = "SELECT  distinct (district) FROM suzuki_campaign_data where vertical = '$district' and to_be_contacted_date >= '$mxdate'";
						...
						$disfilsql = "SELECT  distinct (model_of_vehicle) FROM suzuki_campaign_data where vertical = '$district' and to_be_contacted_date >= '$mxdate'";
						$disres = sqlsrv_query($con,$disfilsql);
                ...
                <div class="table-responsive">
                    <table class="table" id="t01">
						...
						if(isset($_GET['submit']))
						{
							...
							{
								if($filterkey == 'submit' || $filterkey == 'dealer')
								{}
								else
								{
									if($filterval)
						  ...
						  $sqlSelect = "SELECT * FROM suzuki_campaign_data where vertical = '$district' and to_be_contacted_date >= '$mxdate' $where order by to_be_contacted_date ";
							
						}
						else
						{
							
						  $sqlSelect = "SELECT * FROM suzuki_campaign_data where vertical = '$district' and to_be_contacted_date >= '$mxdate' order by to_be_contacted_date";
						}
