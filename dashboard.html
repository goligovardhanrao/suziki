...
<main>
        ...
        <section class="py-3">
            <div class="container ">
                <div class="row m-0" style="justify-content: space-between;">
                    <div class="pb-3">
                        <h1 style="font-size:32px">Welcome <?php  echo $username; ?></h1>
                    </div>
					<?php
        ...
        <div class="d-flex container">
					...
					foreach($ara as $aras)
					{
						...
						<div class="row">
							<div class="col-6 p-2">
								...
								<a href="dealerstatusdata.php?data=<?php echo $querydata; ?>"><?php echo $aras; ?></a>
							</div>
							<div class="col-6 p-2">
								: <?php echo $datacount; ?>
							</div>
			...
			<div class="container"  style="max-width: 300px">
				...
				<form method="get" action="customdata.php">
					<div class="mb-3">
    ...
    <footer id="footer">
        <div class="container">
          ...
          <div style="display: flex; justify-content: center; max-width:500px; float:left;">
			<h5>Contact Us : 9858639999</h5>
		</div>
